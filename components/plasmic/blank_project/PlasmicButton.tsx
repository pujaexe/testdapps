...
// Plasmic Project: kY5J2ePgVmdrExuh7a7cCw
// Component: 33Yf-cJIDFg
...
import projectcss from "./plasmic_blank_project.module.css"; // plasmic-import: kY5J2ePgVmdrExuh7a7cCw/projectcss
import sty from "./PlasmicButton.module.css"; // plasmic-import: 33Yf-cJIDFg/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: qqN8Q0evnby/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: r5aEgwbZm99/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__ofgLc)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__l5Mxn)}
                role={"img"}
              />
            ),
